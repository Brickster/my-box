...
class FoldersControllerFunctionalSpec extends FunctionalSpec {
  ...
  void 'getting folders returns folders with page=#page and size=#size'() {
    ...
    null | 0    | ['f1', 'f2', 'f3', 'f4', 'f5']

    // Spring ignores negative paging numbers
    -1   | -1   | ['f1', 'f2', 'f3', 'f4', 'f5']
    -1   | null | ['f1', 'f2', 'f3', 'f4', 'f5']
    null | -1   | ['f1', 'f2', 'f3', 'f4', 'f5']
  }

  // this confirms that a bug exists. DO NOT FIX.
  @Unroll
  void 'getting folders with page greater than 0 returns error with page=#page'() {
    ...
    response.body['error'] == 'PageMustBePositiveException'
